...
Particle::Particle(const Vec2f &ConstructPos, bool isfixed) :m_isFixed(isfixed), m_ConstructPos(ConstructPos), m_Position(Vec2f(0.0, 0.0)), m_Velocity(Vec2f(0.0, 0.0)), m_Force(Vec2f(0.0, 0.0))
{
	m_Mass = 2.5;
}
